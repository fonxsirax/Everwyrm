...
{
   public class UnityHDRP2023RenderLoopAdapter : IRenderLoopAdapter
   {
      ...
      {
         return "_MSRENDERLOOP_UNITYHDRP6";
      }
      ...
      public void Init(string[] paths)
      {
         ...
         {
            string p = paths[i];
            if (p.EndsWith("microsplat_template_hdrp6_template.txt"))
            {
            ...
            else if (p.EndsWith("microsplat_template_hdrp6_passforward.txt"))
            {
               templatePassForward = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith("microsplat_template_hdrp6_passgbuffer.txt"))
            {
               templatePassGBuffer = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith("microsplat_template_hdrp6_passdepthonly.txt"))
            {
               templatePassDepthOnly = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith("microsplat_template_hdrp6_passmeta.txt"))
            {
               templatePassMeta = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith("microsplat_template_hdrp6_passsceneelection.txt"))
            {
               templatePassSceneSelection = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith("microsplat_template_hdrp6_passshadow.txt"))
            {
               templatePassShadow = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith("microsplat_template_hdrp6_shared.txt"))
            {
            ...
            else if (p.EndsWith("microsplat_template_hdrp6_vert.txt"))
            {
               templateVert = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith("microsplat_template_hdrp6_include.txt"))
            {
               templateInclude = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith("microsplat_template_hdrp6_passmotionvectors.txt"))
            {
               templatePassMotionVector = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith("microsplat_template_hdrp6_passpicking.txt"))
            {
               templatePassPicking = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith("microsplat_template_hdrp6_passtransparentdepthprepass.txt"))
            {
               templateTransparentDepth = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith("microsplat_template_hdrp6_passfullscreendebug.txt"))
            {
               templatePassFullScreenDebug = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith("microsplat_template_hdrp6_passforwardunlit.txt"))
            {
      ...
      StringBuilder BuildTemplate(Blocks blocks, string[] features, string fallbackOverride = null)
      {
         ...
         header.AppendLine("//   Render Pipeline: HDRP2023");
