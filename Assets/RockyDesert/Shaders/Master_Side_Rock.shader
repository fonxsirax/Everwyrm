	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord42 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_43_0 = ( texCoord42 * _DetailNormalScale );
				float4 tex2DNode45 = tex2D( _CliffTexture, temp_output_43_0 );
				float2 uv_MaskMap = packedInput.ase_texcoord6.xy * _MaskMap_ST.xy + _MaskMap_ST.zw;
				...
				float2 texCoord15 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_17_0 = ( texCoord15 * _SandScale );
				float2 uv_MainNormal = packedInput.ase_texcoord6.xy * _MainNormal_ST.xy + _MainNormal_ST.zw;
				...
				float3x3 ase_tangentToWorldFast = float3x3( TangentWS.xyz.x, ase_bitangentWS.x, NormalWS.x, TangentWS.xyz.y, ase_bitangentWS.y, NormalWS.y, TangentWS.xyz.z, ase_bitangentWS.z, NormalWS.z );
				...
				surfaceDescription.BaseColor = ( desaturateVar47 * _Brightness );
				surfaceDescription.Normal = BlendNormal( tex2DNode72 , lerpResult59 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 temp_output_17_0 = ( texCoord15 * _SandScale );
				float2 uv_MainNormal = packedInput.ase_texcoord2.xy * _MainNormal_ST.xy + _MainNormal_ST.zw;
				float3 tex2DNode72 = UnpackNormalScale( tex2D( _MainNormal, uv_MainNormal ), 1.0f );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_MainNormal = packedInput.ase_texcoord4.xy * _MainNormal_ST.xy + _MainNormal_ST.zw;
				float3 tex2DNode72 = UnpackNormalScale( tex2D( _MainNormal, uv_MainNormal ), 1.0f );
				float2 texCoord42 = packedInput.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_43_0 = ( texCoord42 * _DetailNormalScale );
				float2 texCoord15 = packedInput.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_17_0 = ( texCoord15 * _SandScale );
				float3 ase_bitangentWS = packedInput.ase_texcoord5.xyz;
				float3x3 ase_tangentToWorldFast = float3x3( TangentWS.xyz.x, ase_bitangentWS.x, NormalWS.x, TangentWS.xyz.y, ase_bitangentWS.y, NormalWS.y, TangentWS.xyz.z, ase_bitangentWS.z, NormalWS.z );
				float3 tangentToWorldDir83 = mul( ase_tangentToWorldFast, tex2DNode72 );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord42 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_43_0 = ( texCoord42 * _DetailNormalScale );
				float4 tex2DNode45 = tex2D( _CliffTexture, temp_output_43_0 );
				float2 uv_MaskMap = packedInput.ase_texcoord8.xy * _MaskMap_ST.xy + _MaskMap_ST.zw;
				float4 tex2DNode35 = tex2D( _MaskMap, uv_MaskMap );
				float4 lerpResult29 = lerp( ( _Color_Edge * tex2DNode45 ) , tex2DNode45 , tex2DNode35.g);
				float4 lerpResult27 = lerp( ( _Color_Cavities * lerpResult29 ) , lerpResult29 , tex2DNode35.r);
				float2 texCoord15 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_17_0 = ( texCoord15 * _SandScale );
				float2 uv_MainNormal = packedInput.ase_texcoord8.xy * _MainNormal_ST.xy + _MainNormal_ST.zw;
				float3 tex2DNode72 = UnpackNormalScale( tex2D( _MainNormal, uv_MainNormal ), 1.0f );
...
Node;AmplifyShaderEditor.SamplerNode;72;902.6026,696.9993;Inherit;True;Property;_MainNormal;MainNormal;19;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;35;-965.0534,112.0622;Inherit;True;Property;_MaskMap;MaskMap;10;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;19;-1405.974,-1085.577;Inherit;True;Property;_SandTexture;SandTexture;8;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;21;-1359.468,-1299.996;Inherit;False;Property;_SandColor;SandColor;9;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.8962264,0.8962264,0.8962264,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;60;-186.4048,682.5637;Inherit;True;Property;_SandNormal;SandNormal;15;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;52;-832.5822,1849.591;Inherit;True;Property;_Cliff_Normal;Cliff_Normal;14;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;95;2154.164,54.71899;Inherit;False;Constant;_Float0;Float 0;20;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
WireConnection;84;7;95;0
ASEEND*/
//CHKSM=F0D9AAC864BC8D3BBD8D197F4787D7F44CEAB3DB