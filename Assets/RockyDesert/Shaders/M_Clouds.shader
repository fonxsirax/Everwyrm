	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_0607_Day_D = packedInput.ase_texcoord6.xy * _0607_Day_D_ST.xy + _0607_Day_D_ST.zw;
				float4 tex2DNode1 = tex2D( _0607_Day_D, uv_0607_Day_D );
				
				surfaceDescription.BaseColor = ( tex2DNode1 * 3.0 ).rgb;
				...
				surfaceDescription.Emission = tex2DNode1.rgb;
				surfaceDescription.Smoothness = 0.5;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = ( tex2DNode1.a * _Float0 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_0607_Day_D = packedInput.ase_texcoord2.xy * _0607_Day_D_ST.xy + _0607_Day_D_ST.zw;
				float4 tex2DNode1 = tex2D( _0607_Day_D, uv_0607_Day_D );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_0607_Day_D = packedInput.ase_texcoord1.xy * _0607_Day_D_ST.xy + _0607_Day_D_ST.zw;
				float4 tex2DNode1 = tex2D( _0607_Day_D, uv_0607_Day_D );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_0607_Day_D = packedInput.ase_texcoord4.xy * _0607_Day_D_ST.xy + _0607_Day_D_ST.zw;
				float4 tex2DNode1 = tex2D( _0607_Day_D, uv_0607_Day_D );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_0607_Day_D = packedInput.ase_texcoord8.xy * _0607_Day_D_ST.xy + _0607_Day_D_ST.zw;
				float4 tex2DNode1 = tex2D( _0607_Day_D, uv_0607_Day_D );
		...
		Pass
        {
					...
					)
			{
				...
				float2 uv_0607_Day_D = packedInput.ase_texcoord7.xy * _0607_Day_D_ST.xy + _0607_Day_D_ST.zw;
				float4 tex2DNode1 = tex2D( _0607_Day_D, uv_0607_Day_D );
...
WireConnection;4;9;2;0
ASEEND*/
//CHKSM=ADE7661A715CAF8F30E430569E2278308DC11485