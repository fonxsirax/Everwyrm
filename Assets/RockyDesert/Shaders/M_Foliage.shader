...
Shader "M_Foliage"
{
	Properties
	{
		...
		_T_DeadGrass_A1("T_DeadGrass_A1", 2D) = "white" {}
		_T_DeadGrass_A_Normal("T_DeadGrass_A_Normal", 2D) = "bump" {}
		_T_DeadGrass_A_Roughness("T_DeadGrass_A_Roughness", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _T_DeadGrass_A1_ST;
			float4 _T_DeadGrass_A_Normal_ST;
			float4 _T_DeadGrass_A_Roughness_ST;
			...
			sampler2D _T_DeadGrass_A1;
			sampler2D _T_DeadGrass_A_Normal;
			sampler2D _T_DeadGrass_A_Roughness;
						...
						)
			{
				...
				float2 uv_T_DeadGrass_A1 = packedInput.ase_texcoord6.xy * _T_DeadGrass_A1_ST.xy + _T_DeadGrass_A1_ST.zw;
				float4 tex2DNode11 = tex2D( _T_DeadGrass_A1, uv_T_DeadGrass_A1 );
				
				float2 uv_T_DeadGrass_A_Normal = packedInput.ase_texcoord6.xy * _T_DeadGrass_A_Normal_ST.xy + _T_DeadGrass_A_Normal_ST.zw;
				
				float2 uv_T_DeadGrass_A_Roughness = packedInput.ase_texcoord6.xy * _T_DeadGrass_A_Roughness_ST.xy + _T_DeadGrass_A_Roughness_ST.zw;
				
				surfaceDescription.BaseColor = tex2DNode11.rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( _T_DeadGrass_A_Normal, uv_T_DeadGrass_A_Normal ), 1.0f );
				...
				surfaceDescription.Smoothness = tex2D( _T_DeadGrass_A_Roughness, uv_T_DeadGrass_A_Roughness ).r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_T_DeadGrass_A1 = packedInput.ase_texcoord2.xy * _T_DeadGrass_A1_ST.xy + _T_DeadGrass_A1_ST.zw;
				float4 tex2DNode11 = tex2D( _T_DeadGrass_A1, uv_T_DeadGrass_A1 );
				
				float2 uv_T_DeadGrass_A_Normal = packedInput.ase_texcoord2.xy * _T_DeadGrass_A_Normal_ST.xy + _T_DeadGrass_A_Normal_ST.zw;
				
				float2 uv_T_DeadGrass_A_Roughness = packedInput.ase_texcoord2.xy * _T_DeadGrass_A_Roughness_ST.xy + _T_DeadGrass_A_Roughness_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_T_DeadGrass_A1 = packedInput.ase_texcoord1.xy * _T_DeadGrass_A1_ST.xy + _T_DeadGrass_A1_ST.zw;
				float4 tex2DNode11 = tex2D( _T_DeadGrass_A1, uv_T_DeadGrass_A1 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_T_DeadGrass_A_Normal = packedInput.ase_texcoord4.xy * _T_DeadGrass_A_Normal_ST.xy + _T_DeadGrass_A_Normal_ST.zw;
				
				float2 uv_T_DeadGrass_A_Roughness = packedInput.ase_texcoord4.xy * _T_DeadGrass_A_Roughness_ST.xy + _T_DeadGrass_A_Roughness_ST.zw;
				
				float2 uv_T_DeadGrass_A1 = packedInput.ase_texcoord4.xy * _T_DeadGrass_A1_ST.xy + _T_DeadGrass_A1_ST.zw;
				float4 tex2DNode11 = tex2D( _T_DeadGrass_A1, uv_T_DeadGrass_A1 );
		...
		Pass
		{
				...
				)
			{
				...
				SmoothSurfaceDescription surfaceDescription = (SmoothSurfaceDescription)0;
				float2 uv_T_DeadGrass_A_Normal = packedInput.ase_texcoord3.xy * _T_DeadGrass_A_Normal_ST.xy + _T_DeadGrass_A_Normal_ST.zw;
				
				float2 uv_T_DeadGrass_A_Roughness = packedInput.ase_texcoord3.xy * _T_DeadGrass_A_Roughness_ST.xy + _T_DeadGrass_A_Roughness_ST.zw;
				
				float2 uv_T_DeadGrass_A1 = packedInput.ase_texcoord3.xy * _T_DeadGrass_A1_ST.xy + _T_DeadGrass_A1_ST.zw;
				float4 tex2DNode11 = tex2D( _T_DeadGrass_A1, uv_T_DeadGrass_A1 );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_T_DeadGrass_A1 = packedInput.ase_texcoord8.xy * _T_DeadGrass_A1_ST.xy + _T_DeadGrass_A1_ST.zw;
				float4 tex2DNode11 = tex2D( _T_DeadGrass_A1, uv_T_DeadGrass_A1 );
				
				float2 uv_T_DeadGrass_A_Normal = packedInput.ase_texcoord8.xy * _T_DeadGrass_A_Normal_ST.xy + _T_DeadGrass_A_Normal_ST.zw;
				
				float2 uv_T_DeadGrass_A_Roughness = packedInput.ase_texcoord8.xy * _T_DeadGrass_A_Roughness_ST.xy + _T_DeadGrass_A_Roughness_ST.zw;
		...
		Pass
        {
					...
					)
			{
				...
				float2 uv_T_DeadGrass_A1 = packedInput.ase_texcoord7.xy * _T_DeadGrass_A1_ST.xy + _T_DeadGrass_A1_ST.zw;
				float4 tex2DNode11 = tex2D( _T_DeadGrass_A1, uv_T_DeadGrass_A1 );
...
/*ASEBEGIN
Version=19801
Node;AmplifyShaderEditor.SamplerNode;11;-602,-183.5;Inherit;True;Property;_T_DeadGrass_A1;T_DeadGrass_A1;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;12;-592,285.5;Inherit;True;Property;_T_DeadGrass_A_Normal;T_DeadGrass_A_Normal;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;13;-615,58.5;Inherit;True;Property;_T_DeadGrass_A_Roughness;T_DeadGrass_A_Roughness;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
