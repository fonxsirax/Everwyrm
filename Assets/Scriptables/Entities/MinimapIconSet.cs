...
/// `Assets/Scriptables/Resources/UI/MinimapIcons.asset` (sem tocar na cena).
/// Sprites vazios = o minimapa usa os gerados em código (seta/X/ponto).
/// O DragonMinimap carrega este asset via Resources.Load(ResourcePath).
/// </summary>
[CreateAssetMenu(menuName = "Everwyrm/Minimap Icon Set", fileName = "MinimapIcons")]
public class MinimapIconSet : ScriptableObject
{
    /// <summary>Onde o asset vive, relativo a uma pasta Resources.</summary>
    public const string ResourcePath = "UI/MinimapIcons";
